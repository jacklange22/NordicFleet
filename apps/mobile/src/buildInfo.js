...
// If the phone's Settings footer shows an older tag than this, it is running
// a stale bundle → do the clean reinstall in PHONE_INSTALL_NEXT_STEPS.md.
export const BUILD_TAG = '2026-05-30 · overnight-stabilization';
